...
}, function (email, password, cb) { return __awaiter(_this, void 0, void 0, function () {
    var user, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, user_1.default.findOne({ email: email, password: password })];
            case 1:
                user = _a.sent();
                if (!user) {
...
}, function (jwtPayload, cb) { return __awaiter(_this, void 0, void 0, function () {
    var user, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
